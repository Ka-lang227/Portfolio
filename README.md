...
- 🟢 **In-Place Editing** – Double-click any item to edit its name using a clean modal.
- 🟢 **Delete Items** – Quickly remove any step with a delete button.
- 🟢 **Responsive Design** – Optimized for desktop, tablet, and mobile devices.
- 🟢 **Reset Routine** – Clear the entire grid and start fresh.
- 🟢 **Export as JSON** – Save your routine locally as a JSON file.
- 🟢 **Import JSON** – Load routines from a previously saved JSON file.
- 🟢 **Drag-and-Drop Reordering** – Rearrange steps within the grid effortlessly.
- 🟢 **Category Filtering** – Filter grid items based on categories like Warmup, Main, or Cooldown.
...
## 🎯 Usage Instructions
1. **Drag** routine steps from the sidebar into the grid.
2. **Double-click** an item to edit its text using the modal.
